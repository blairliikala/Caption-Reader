var c=class{static timecodeToSeconds(t=""){if(!/^[0-9][0-9]/.test(t)||typeof t!="string")return;let e=t.split(":");if(!e||e.length===1)return t;let s=parseInt(e[0],10),r=parseInt(e[1],10),a=parseInt(e[2],10),l=t.split(".");return l.length===1&&(l=t.split(",")),s*3600+r*60+a+l[1]/1e3}static isValidJSON(t){return/^[\],:{}\s]*$/.test(t.replace(/\\["\\/bfnrtu]/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+-]?\d+)?/g,"]").replace(/(?:^|:|,)(?:\s*\[)+/g,""))}static isTimecode(t){return/^[0-9][0-9]/.test(t)}static prettyTimecode(t){if(!/^[0-9][0-9]/.test(t)||typeof t!="string")return;let e=t.split(":");if(e.length===0)return[];e.length-1===2&&e[0]==="00"&&e.splice(0,1);let s=e[e.length-1];return s=s.replace(",","."),s=Math.round(s),s<10&&(s=`0${s}`),e[e.length-1]=s,e.join(":")}static secondsToTimecode(t=0){return typeof t!="number"?"":t<0?"00:00:00":new Date(t*1e3).toISOString().substring(11,11+8)}static getTheme(t){return t==="light"?"light":t==="dark"?"dark":matchMedia("(prefers-color-scheme: light)").matches?"light":"dark"}static getSupportedFileType(t){let i=t.split("."),e=i[i.length-1];return["vtt","srt"].find(r=>r===e)}};function S(o,t){let i=/<(\d\d:\d\d:\d\d\.\d\d\d)>/,e=o.split(i),s=[];for(let r=1;r<e.length;r+=1)r===1&&s.push({seconds:t,text:e[0],status:void 0}),s.push({seconds:c.timecodeToSeconds(e[r]),text:e[r+1],status:void 0}),r+=1;return s}function m(o){if(!o.cues)return;let t=Object.entries(o.cues).map(e=>{let s=e[1];return{chapter:s.id,status:"",text:s.text.split(`
`).map(r=>r.replace(/^\s+/g,"")),subCues:void 0,seconds:{start:s.startTime,end:s.endTime},timecode:{start:c.secondsToTimecode(s.startTime),end:c.secondsToTimecode(s.endTime)}}});return{kind:o.kind,lang:o.language,label:o.label,header:o.id,styles:void 0,cues:t}}function b(o){return o.map(t=>{let i=t.text[1]||"";return t.subCues=void 0,i.includes("<")&&(t.subCues=S(i,t.seconds.start)),t})}function v(o,t){if(!o||o.length===0)return;let i=!1,e=o[0];if(e.seconds.start>t){let s={chapter:"",text:[],type:"spacer",timecode:{start:c.secondsToTimecode(0),end:c.secondsToTimecode(e.seconds.start)},seconds:{start:0,end:e.seconds.start}};o.unshift(s)}return o.forEach((s,r)=>{let a=o[r+1];if(i){i=!1;return}if(!a)return;if(a.seconds.start-s.seconds.end>t){let u=s.seconds.end,n=a.seconds.start,h={chapter:"",text:[],type:"spacer",timecode:{start:c.secondsToTimecode(u),end:c.secondsToTimecode(u)},seconds:{start:u,end:n}};o.splice(r+1,0,h),i=!0}return[]}),o}function y(o){return o&&o.sort((t,i)=>t.seconds.start<i.seconds.start?-1:t.seconds.start>i.seconds.start?1:0)}function x(o,t){let i=o.split(`
`),e={kind:t||i[0].startsWith("WEBVTT"),lang:void 0,header:void 0,styles:void 0,cues:[]},s={text:[]},r=0,a=!1,l="",u="";for(let n of i){if(n.startsWith("WEBVTT")){let h=n.split(" - ");h.length>0&&(e.header=h[1])}else if(n.startsWith("Kind")){let h=n.split(":");e.kind=h[1]?.trim()}else if(n.startsWith("Language")){let h=n.split(":");e.lang=h[1]?.trim()}else if(n.startsWith("STYLE"))a=!0,u="styles";else if(!n.startsWith("NOTE"))if(a===!0&&n!=="")l+=n;else if(a===!0&&n==="")e.styles=l,a=!1,l="";else if(n!==""&&c.isTimecode(i[r+1]))s.chapter=n;else if(c.isTimecode(n)){let h=n.split("-->"),p=h[1]?h[1]?.split(" "):void 0,f=p?p[1]?.trim():"";s.timecode={start:h[0].trim(),end:f},s.seconds={start:c.timecodeToSeconds(h[0]),end:c.timecodeToSeconds(f)},s.length=s.seconds.start+s.seconds.end;let g=n.split(" ");g.length>2&&(s.styles=g.splice(3).join(" "))}else n!==""&&(t==="srt"?s.text.push(n.replace(/(<([^>]+)>)/gi,"")):s.text.push(n));n===""&&s.timecode?.start!==void 0&&(a&&(a=!1,u=""),s.active=!1,e.cues.push(s),s={text:[]}),r+=1}return e}function T(){return`<style id="theme_a">
  #root {
    display: block;
